    ...
    <div className="left-menu" ref={props.reference.leftMenu}>
      <div className="left-content" ref={props.reference.leftContent}>
        <ul className="list" ref={navList}>
          ...
          >
            <i className="fa-solid fa-people-group"></i> Following
          </li>
        </ul>
        <hr></hr>
        <div id="help-creators">
          Help creators online by becoming a virtual sponsor, then reap your
          benefits!
          <button>
            <a href="https://pl.wikipedia.org/wiki/Sponsoring">See details</a>
          </button>
        </div>
        <hr></hr>
        <ul className="list2">
        ...
        <div id="footer">
          ...
          <div id="footer-text">
            ...
            sed sollicitudin elit. Nulla congue porttitor nisl id feugiat. Donec
            gravida vitae ante eu imperdiet. In hac habitasse platea dictumst.
            Etiam ipsum eros, varius rhoncus ligula sit amet, pellentesque
            hendrerit metus. Nam dictum tellus in quam sollicitudin, non
