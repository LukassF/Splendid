  ...
  function passwordCheck(e) {
    if (
      JSON.parse(window.localStorage.getItem("usersArray")).filter(
        (item) => item.username === login && e.target.value === item.password
      ).length !== 0
    )
      return true;
    else return false;
    ...
    <main id="login-page-main">
      <section>
        ...
        <div id="login-left" ref={loginLeftRef}>
          <CSSTransition
            in={mainText === "Not registered yet?"}
            timeout={600}
            unmountOnExit
              ...
              <article ref={contentLoginRef1}>
                  ...
                  <input
                    ...
                    onBlur={(e) => {
                      if (
                        ...
                        JSON.parse(
                          window.localStorage.getItem("usersArray")
                        ).filter((item) => item.username === login).length === 0
                      ) {
                  ...
                  <input
                    ...
                    onBlur={(e) => {
                      if (
                        ...
                        JSON.parse(
                          window.localStorage.getItem("usersArray")
                        ).filter((item) => item.username === login).length ===
                          0 ||
                        !passwordCheck(e)
                      ) {
                ...
                <div id="login-with">
                  ...
                  <div>
                    ...
                    <div>
                      <img
                        src="https://img.freepik.com/darmowe-ikony/szukaj_318-265146.jpg"
                        alt="google-logo"
                        width="30px"
                      />
                    </div>
        ...
        <div id="login-right" ref={loginRightRef}>
          ...
          <CSSTransition
            in={mainText === "Already registered?"}
            timeout={600}
            unmountOnExit
              ...
              <article ref={contentLoginRef2}>
                ...
                <div className="password-container">
                  ...
                  <i
                    ...
                    id="see-password-icon"
                    onClick={() =>
                      (passwordRef3.current.type =
                        passwordRef3.current.type === "password"
                          ? "text"
                          : "password")
                    }
                  />
                  ...
                  onClick={() => {
                    if (
                      ...
                      setUserObject({
                        ...
                        backgroundImage:
                          "https://obiektowe.tarkett.pl/media/img/M/THH_25121916_25131916_25126916_25136916_001.jpg",
                      });
                      setWelcome(true);
