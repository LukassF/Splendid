  ...
  return (
    <div id="upload-button-profile">
      <ul ref={uploadListRef}>
        <li>
          Don't forget to check the video's orientation before uploading it. You
          don't want to end up with a sideways or upside-down video!
        </li>
        <li>
          When adding a description, try to keep it short and sweet. People tend
          to have short attention spans, so a concise and engaging description
          can help grab their attention.
        </li>
        <li>
          If you're using filters or other effects, make sure they don't
          overpower the video. The goal is to enhance the video, not distract
          from it.
        </li>
      </ul>
