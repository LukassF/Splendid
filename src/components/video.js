...
function reducer(state, action) {
  switch (action.type) {
    case "like":
      return {
        color: state.color === "black" ? "rgba(255, 135, 135, 0.7)" : "black",
      };
    case "mouseOver":
      return {
        color:
          state.color === "rgba(255, 135, 135, 0.7)"
    ...
    <div className="video-container" onClick={(event) => closeComments(event)}>
      <div className="creator">
        ...
        <div>
          ...
          text and so on.graphic or web designs. The passage is attributed to an
          unknown typesetter in the 15th century who is thought to hav
        </div>
      </div>
        ...
        <div className="black-background" onClick={playVideo}>
          {props.renderButtons && (
            <div className="buttons-small">
              <span>
                <i className="fa fa-heart"></i> {like}k
              </span>
              <span
                onClick={() => {
                  if (
              ...
              >
                ...
                {props.allow ? comment + "k" : "Disabled"}
              </span>
              <span>
                <i className="fa fa-share"></i> {share}k
              </span>
            </div>
          )}
        ...
        {props.renderButtons && (
          <ul>
            ...
            >
              ...
              ></i>
              <div id="like-quantity">{like}K</div>
            </li>
            <li
              onClick={() => {
                if (
