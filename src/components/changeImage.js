        ...
        props.setModifiedUsers((prev) => [
          {
            ...
            backgroundImage:
              backgImgRef.current.value.length !== 0
                ? backgImgRef.current.value
                : item.backgroundImage,
            profileImage:
              profileImgRef.current.value.length !== 0
  ...
  return (
    ...
    >
      <form ref={props.reference}>
        ...
        <ol>
          <li>
            Find the URL of the image you want to use. You can do this by
            right-clicking on the image and selecting "Copy image address" or
            "Copy image URL" depending on your browser.
          </li>
          <li>
            Paste the URL of the image you want to use in the space provided.
            Make sure that the URL is correct and that the image is publicly
            accessible.
          </li>
          <li>Click "Confirm" to save your changes.</li>
          <li>
            Check your profile or account page to make sure that the new image
